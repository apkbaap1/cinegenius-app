...
export const ClapperboardIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M20.2 6 3.8 6.8A2 2 0 0 0 2 8.8v8.4a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-1.8-2Z"/>
        <path d="m.1 4.1 3.5 3.5"/>
        <path d="m5.5 1.5 3.5 3.5"/>
        <path d="m11 1.5 3.5 3.5"/>
        <path d="m16.5 1.5 3.5 3.5"/>
    </svg>
);
